...
{
	MN_SP_MAIN + (MN_SP_TIMEATTACK << 6) + (MN_SP_LEVELSELECT << 18),
	"M_ATTACK",
...
{
	MN_SP_MAIN + (MN_SP_NIGHTSATTACK << 6) + (MN_SP_LEVELSELECT << 18),
	"M_NIGHTS", // HAMALAYAN
...
menu_t OP_LegacyOptionsDef = DEFAULTMENUSTYLE(MN_OP_MAIN, NULL, OP_LegacyOptionsMenu, &OP_MainDef, 30, 30);
menu_t OP_LegacyCreditsDef = DEFAULTMENUSTYLE(MN_OP_MAIN, NULL, OP_LegacyCreditsMenu, &OP_LegacyOptionsDef, 30, 0);
