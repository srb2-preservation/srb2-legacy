...
//  name, singularity, priority, pitch, volume, data, length, skinsound, usefulness, lumpnum, caption
  ...
  {"gclose", false,  64,  0, -1, NULL, 0,        -1,  -1, LUMPERROR, "idk"},
  ...
  {"shield", false,  60,  0, -1, NULL, 0,        -1,  -1, LUMPERROR, "Shield"}, // generic GET!
  {"shldls", false,  64,  0, -1, NULL, 0,        -1,  -1, LUMPERROR, "Shield"},
